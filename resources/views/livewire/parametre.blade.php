                        ...
                        <div class="p-6 bg-white border-b border-gray-200">
                            <form wire:submit="save">
                                <div>
                                    ...
                                    <x-input wire:model.live="delais_vente" id="delais_vente" type="text" class="block mt-1 w-full" />
                                ...
                                <div>
                                    ...
                                    <x-input wire:model.live="delais_location" id="delais_location" type="text" class="block mt-1 w-full" />
